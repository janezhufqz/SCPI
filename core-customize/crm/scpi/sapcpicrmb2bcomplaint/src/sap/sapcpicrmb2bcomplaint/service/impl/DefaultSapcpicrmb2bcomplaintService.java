...
public class DefaultSapcpicrmb2bcomplaintService implements Sapcpicrmb2bcomplaintService
{
	private static final Logger LOG = LoggerFactory.getLogger(DefaultSapcpicrmb2bcomplaintService.class);
	...
	{
		return DefaultSapcpicrmb2bcomplaintService.class.getResourceAsStream("/sapcpicrmb2bcomplaint/sap-hybris-platform.png");
	}
