 ...
 */
package de.hybris.platform.sap.sapcpicrmibase.service.impl;
...
public class DefaultSapcpicrmibaseService implements SapcpicrmibaseService
{
	private static final Logger LOG = LoggerFactory.getLogger(DefaultSapcpicrmibaseService.class);
	...
	{
		return DefaultSapcpicrmibaseService.class.getResourceAsStream("/sapcpicrmibase/sap-hybris-platform.png");
	}
