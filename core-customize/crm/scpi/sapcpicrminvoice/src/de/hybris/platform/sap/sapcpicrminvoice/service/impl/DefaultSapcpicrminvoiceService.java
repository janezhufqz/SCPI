 ...
 */
package de.hybris.platform.sap.sapcpicrminvoice.service.impl;
...
public class DefaultSapcpicrminvoiceService implements SapcpicrminvoiceService
{
	private static final Logger LOG = LoggerFactory.getLogger(DefaultSapcpicrminvoiceService.class);
	...
	{
		return DefaultSapcpicrminvoiceService.class.getResourceAsStream("/sapcpicrminvoice/sap-hybris-platform.png");
	}
