...
public class DefaultSapcpicrmticketsystemService implements SapcpicrmticketsystemService
{
	private static final Logger LOG = LoggerFactory.getLogger(DefaultSapcpicrmticketsystemService.class);
	...
	{
		return DefaultSapcpicrmticketsystemService.class.getResourceAsStream("/sapcpicrmticketsystem/sap-hybris-platform.png");
	}
