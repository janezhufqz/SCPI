...
public class DefaultSapcpicrmb2bticketsystemService implements Sapcpicrmb2bticketsystemService
{
	private static final Logger LOG = LoggerFactory.getLogger(DefaultSapcpicrmb2bticketsystemService.class);
	...
	{
		return DefaultSapcpicrmb2bticketsystemService.class.getResourceAsStream("/sapcpicrmb2bticketsystem/sap-hybris-platform.png");
	}
