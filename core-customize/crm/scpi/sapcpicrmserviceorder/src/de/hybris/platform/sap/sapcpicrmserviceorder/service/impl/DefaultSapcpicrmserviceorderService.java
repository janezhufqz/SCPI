 ...
 */
package de.hybris.platform.sap.sapcpicrmserviceorder.service.impl;
...
public class DefaultSapcpicrmserviceorderService implements SapcpicrmserviceorderService
{
	private static final Logger LOG = LoggerFactory.getLogger(DefaultSapcpicrmserviceorderService.class);
	...
	{
		return DefaultSapcpicrmserviceorderService.class.getResourceAsStream("/sapcpicrmserviceorder/sap-hybris-platform.png");
	}
