...
public class DefaultSapcpicrmcomplaintService implements SapcpicrmcomplaintService
{
	private static final Logger LOG = LoggerFactory.getLogger(DefaultSapcpicrmcomplaintService.class);
	...
	{
		return DefaultSapcpicrmcomplaintService.class.getResourceAsStream("/sapcpicrmcomplaint/sap-hybris-platform.png");
	}
