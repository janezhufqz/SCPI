...
public class DefaultSapcpicrmb2breturnorderService implements Sapcpicrmb2breturnorderService
{
	private static final Logger LOG = LoggerFactory.getLogger(DefaultSapcpicrmb2breturnorderService.class);
	...
	{
		return DefaultSapcpicrmb2breturnorderService.class.getResourceAsStream("/sapcpicrmb2breturnorder/sap-hybris-platform.png");
	}
