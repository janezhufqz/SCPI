...
public class DefaultSapcpicrmreturnorderService implements SapcpicrmreturnorderService
{
	private static final Logger LOG = LoggerFactory.getLogger(DefaultSapcpicrmreturnorderService.class);
	...
	{
		return DefaultSapcpicrmreturnorderService.class.getResourceAsStream("/sapcpicrmreturnorder/sap-hybris-platform.png");
	}
