 ...
 *
 */
public class SapCpiReturnOrderCreationNotificationPersistenceHook implements PrePersistHook
{
	...
	private static final Logger LOG = LoggerFactory.getLogger(SapCpiReturnOrderCreationNotificationPersistenceHook.class);
