 ...
 *
 */
public class SapCpiReturnOrderCreditMemoNotificationPersistenceHook implements PrePersistHook
{
	...
	private static final Logger LOG = LoggerFactory.getLogger(SapCpiReturnOrderCreditMemoNotificationPersistenceHook.class);
	...
	public Optional<ItemModel> execute(final ItemModel item)
	{
		if (item instanceof ReturnRequestModel)
		{
			...
			inboundHelper.processOrderCreditMemoNotififcationFromHub(lReturnRequest.getCode(), lReturnRequest.getCreditMemoNumber());
